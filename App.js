          ...
          <View style={styles.body}>
            <View style={styles.sectionContainer}>
              ...
              <Text style={styles.sectionDescription}>
                <Text style={styles.highlight}>Sweet Tooth Waffles</Text> has
                waffles with cornflakes and chocolate spread, other than usual
                fillings such as kaya and peanut butter
              </Text>
            ...
            <View style={styles.sectionContainer}>
              <Text style={styles.sectionDescription}>
                ...
                price. Their top selling item would be chicken and spaghetti.
              </Text>
